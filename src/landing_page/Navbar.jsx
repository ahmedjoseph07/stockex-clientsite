      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900 border-b-2 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6 ">
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            { isLoggedIn ? (
                <Link to="https://stockex-dashboard.vercel.app">Dashboard</Link>
            ) : (
            ...
            <div className="p-4 md:p-5">
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                  Not registered? <Link to="/signup" className="text-green-700 hover:underline dark:text-green-500">Create account</Link>
                </div>
              </form>
            </div>
          </div>
